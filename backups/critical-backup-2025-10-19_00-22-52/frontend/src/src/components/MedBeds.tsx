...
export default function MedBeds() {
  ...
  const biometrics = [
    ...
    { label: "Energy Level", value: "87%", status: "good", icon: Zap, color: "text-yellow-600" },
    { label: "Recovery Score", value: "94/100", status: "excellent", icon: TrendingUp, color: "text-blue-600" },
    { label: "Neural Activity", value: "Optimal", status: "normal", icon: Brain, color: "text-purple-600" },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-2xl p-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/90">Quantum healing technology for optimal health and performance</p>
        </div>
      </div>
                ...
                {session.status === "completed" ? (
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={() => alert(`Cashing out $${(session.duration / 60 * 150).toFixed(2)} reward`)}
                      ...
                      <button
                        onClick={() => alert(`Withdrawing $${(session.duration / 60 * 150).toFixed(2)} to wallet`)}
      ...
      <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-blue-800 mt-1">
            Med Bed sessions are monitored by AI-powered health systems. Emergency protocols are active
            24/7. Consult with your health advisor before booking enhancement sessions.
          </p>
        </div>
      </div>
        ...
        {showBookingModal && selectedChamber && (
          ...
          >
            ...
            >
              ...
              {/* Chamber Info */}
              <div className={`bg-gradient-to-br ${selectedChamber.color} rounded-xl p-6 text-white mb-6`}>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className={`flex-1 px-6 py-3 bg-gradient-to-r ${selectedChamber.color} text-white font-semibold rounded-xl hover:shadow-lg transition-shadow`}
                >
                  Confirm Booking
                </button>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-slate-200">
                ...
                <p className="text-xs text-slate-500 mt-2">
                  Insurance coverage may apply. Check with your health provider.
                </p>
              </div>
            </motion.div>
          </motion.div>
