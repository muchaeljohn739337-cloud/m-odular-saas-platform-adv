...
export default function AdminPanel() {
  ...
  const [selectedTab, setSelectedTab] = useState<"overview" | "users" | "security" | "system">("overview");
  ...
  const handleSaveBalance = (userId: string) => {
    ...
    alert(`✅ Balance updated for ${user?.name}\nNew balance: $${parsedBalance.toFixed(2)}`);
  };
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            >
              ...
              <p className="text-4xl font-bold">${(stats.totalVolume / 1000).toFixed(1)}K</p>
          ...
          {selectedTab === "users" && (
            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
              <div className="p-6 bg-gradient-to-r from-slate-800 to-slate-900 text-white">
                ...
                <p className="text-slate-300 mt-2">Manage user accounts, permissions, and access</p>
              </div>
              ...
              <div className="mx-6 mt-6 p-4 bg-blue-50 border-2 border-blue-200 rounded-xl">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-1">Admin Access Required</h3>
                    <p className="text-sm text-blue-700">
                      You can edit user balances directly. Click the <Settings size={14} className="inline text-blue-600" /> icon next to any balance to modify it. 
                    ...
                    <tbody>
                      {users.map((user) => (
                        <tr key={user.id} className="border-b border-slate-100 hover:bg-slate-50">
                          ...
                          <td className="py-4 px-4 text-sm text-slate-600">{user.lastActive}</td>
                          <td className="py-4 px-4">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-green-50 border-2 border-green-200 rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-green-900">Backend Protected</p>
                      <p className="text-sm text-green-700">Only admins can access backend endpoints</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-blue-50 border-2 border-blue-200 rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700">Users automatically restricted from admin features</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-purple-50 border-2 border-purple-200 rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-purple-900">Session Management</p>
                      <p className="text-sm text-purple-700">JWT tokens with 7-day expiration</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-slate-50 rounded-xl border-2 border-slate-200">
                  <p className="font-semibold text-slate-800 mb-2">Frontend Server</p>
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                    <span className="text-green-600 font-semibold">Online - Port 3000</span>
                  </div>
                </div>

                <div className="p-4 bg-slate-50 rounded-xl border-2 border-slate-200">
                  <p className="font-semibold text-slate-800 mb-2">Backend Server</p>
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                    <span className="text-green-600 font-semibold">Online - Port 4000</span>
                  </div>
                </div>
                ...
                <div className="p-4 bg-slate-50 rounded-xl border-2 border-slate-200">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-yellow-600 font-semibold">Offline - Using Mock Data</span>
                  </div>
                </div>

                <div className="p-4 bg-slate-50 rounded-xl border-2 border-slate-200">
                  <p className="font-semibold text-slate-800 mb-2">Twilio API</p>
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
          ...
          {selectedTab === "overview" && (
            <div className="bg-white rounded-2xl shadow-2xl p-6">
              ...
              <p className="text-slate-600 mb-4">
                Welcome to the ADVANCIA PAYLEDGER Admin Panel. From here you can:
              </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-700">
                      ...
                      Regular users attempting to access this page will be automatically redirected. 
